...
def run_test_count_cosines_from():
    ...
    # Test 2
    expected = 2
    answer = count_cosines_from(4, 8, 0.56)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3
    expected = 2
    answer = count_cosines_from(6, 9, 0.25)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4
    expected = 3
    answer = count_cosines_from(2, 7, 0.23)
    ...
    # Test 6
    expected = 2
    answer = count_cosines_from(3, 6, 0.23)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2
    expected = 0.37896  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3
    expected = 1.32896  # This is APPROXIMATELY the correct answer.
